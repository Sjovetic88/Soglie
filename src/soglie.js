...
function formattaDataMMDDYYYY(dataStr) {
  ...
  return parti[1] + "-" + parti[2] + "-" + parti[0];
}
...
async function caricaPartiteStoriche(campionato, dataRiferimento, giorniIndietro, env) {
  ...
  const query = "SELECT * FROM validazione_risultati WHERE campionato = ? AND date >= ? AND date < ? AND fthg IS NOT NULL AND ftag IS NOT NULL ORDER BY date ASC;";
...
async function salvaSogliaAttiva(campionato, dataOggi, soglie, env) {
  const query = "INSERT INTO soglie_attive (campionato, date_aggiornamento, soglia_1, soglia_X, soglia_2, soglia_gg, soglia_ng, soglia_u05, soglia_o05, soglia_u15, soglia_o15, soglia_u25, soglia_o25, soglia_u35, soglia_o35, soglia_u45, soglia_o45, soglia_sg0, soglia_sg1, soglia_sg2, soglia_sg3, soglia_sg4, soglia_sg5, soglia_sg6p) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ON CONFLICT(campionato) DO UPDATE SET date_aggiornamento = excluded.date_aggiornamento, soglia_1=excluded.soglia_1, soglia_X=excluded.soglia_X, soglia_2=excluded.soglia_2, soglia_gg=excluded.soglia_gg, soglia_ng=excluded.soglia_ng, soglia_u05=excluded.soglia_u05, soglia_o05=excluded.soglia_o05, soglia_u15=excluded.soglia_u15, soglia_o15=excluded.soglia_o15, soglia_u25=excluded.soglia_u25, soglia_o25=excluded.soglia_o25, soglia_u35=excluded.soglia_u35, soglia_o35=excluded.soglia_o35, soglia_u45=excluded.soglia_u45, soglia_o45=excluded.soglia_o45, soglia_sg0=excluded.soglia_sg0, soglia_sg1=excluded.soglia_sg1, soglia_sg2=excluded.soglia_sg2, soglia_sg3=excluded.soglia_sg3, soglia_sg4=excluded.soglia_sg4, soglia_sg5=excluded.soglia_sg5, soglia_sg6p=excluded.soglia_sg6p;";
...
function preparaQuerySalvataggioCache(d, env) {
  const query = "INSERT INTO calibrazioni_giornaliere (campionato, date_calibrazione, finestra_giorni, raggio_smussamento, penale_applicata, soglia_1, soglia_X, soglia_2, soglia_gg, soglia_ng, soglia_u05, soglia_o05, soglia_u15, soglia_o15, soglia_u25, soglia_o25, soglia_u35, soglia_o35, soglia_u45, soglia_o45, soglia_sg0, soglia_sg1, soglia_sg2, soglia_sg3, soglia_sg4, soglia_sg5, soglia_sg6p) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ON CONFLICT(campionato, date_calibrazione) DO UPDATE SET finestra_giorni=excluded.finestra_giorni, raggio_smussamento=excluded.raggio_smussamento, penale_applicata=excluded.penale_applicata, soglia_1=excluded.soglia_1, soglia_X=excluded.soglia_X, soglia_2=excluded.soglia_2, soglia_gg=excluded.soglia_gg, soglia_ng=excluded.soglia_ng, soglia_u05=excluded.soglia_u05, soglia_o05=excluded.soglia_o05, soglia_u15=excluded.soglia_u15, soglia_o15=excluded.soglia_o15, soglia_u25=excluded.soglia_u25, soglia_o25=excluded.soglia_o25, soglia_u35=excluded.soglia_u35, soglia_o35=excluded.soglia_o35, soglia_u45=excluded.soglia_u45, soglia_o45=excluded.soglia_o45, soglia_sg0=excluded.soglia_sg0, soglia_sg1=excluded.soglia_sg1, soglia_sg2=excluded.soglia_sg2, soglia_sg3=excluded.soglia_sg3, soglia_sg4=excluded.soglia_sg4, soglia_sg5=excluded.soglia_sg5, soglia_sg6p=excluded.soglia_sg6p;";
...
async function eseguiBacktestInStreaming(campionato, env, writer, encoder) {
  const queryTuttiMatch = "SELECT date, home_team, away_team, fthg, ftag, prob_1, prob_X, prob_2, prob_gg, prob_ng, prob_u05, prob_o05, prob_u15, prob_o15, prob_u25, prob_o25, prob_u35, prob_o35, prob_u45, prob_o45, prob_sg0, prob_sg1, prob_sg2, prob_sg3, prob_sg4, prob_sg5, prob_sg6p FROM validazione_risultati WHERE campionato = ? AND date IS NOT NULL AND fthg IS NOT NULL AND ftag IS NOT NULL ORDER BY date ASC;";
  ...
  if (tuttiMatch.length < 150) {
    ...
    await writer.write(encoder.encode("data: " + msg + String.fromCharCode(10) + String.fromCharCode(10)));
    return;
  }
  ...
  for (let i = primaDataSimulabileIdx; i < dateUniche.length; i++) {
    ...
    if (matchDelGiorno.length > 0) {
      ...
      await writer.write(encoder.encode("data: " + chunkProgresso + String.fromCharCode(10) + String.fromCharCode(10)));
    }
  }
  ...
  await writer.write(encoder.encode("data: " + chunkFinale + String.fromCharCode(10) + String.fromCharCode(10)));
}

// ==========================================
// EXPORT DEFAULT (ENTRY POINT CLOUDFLARE)
// ==========================================
    ...
    try {
      ...
      if (path === "/api/campionati") {
        try {
          ...
          const queryDati = "SELECT campionato, MAX(date) as ultima_data, COUNT(*) as totale_match FROM validazione_risultati WHERE campionato IS NOT NULL GROUP BY campionato ORDER BY campionato ASC;";
          ...
          for (const r of d1Results) {
            const queryUltimoMatch = "SELECT date, home_team, away_team, fthg, ftag FROM validazione_risultati WHERE campionato = ? AND date = ? LIMIT 1;";
      ...
      if (path === "/backtest") {
        ...
        ctx.waitUntil((async () => {
          try {
            ...
            await writer.write(encoder.encode("data: " + errorMsg + String.fromCharCode(10) + String.fromCharCode(10)));
          } finally {
            await writer.close();
          }
        })());
...
// ==========================================
// CODICE GRAPHICO (DASHBOARD) - ESENTE DA BACKTICK E ESCAPES
// ==========================================
...
function ottieniHTMLDashboardEngineCompleto() {
  var htmlLines = [
    ...
    "            </div>",
    "            <div id='soglie-accordions-container' class='space-y-3'></div>",
    "        </div>",
    "    </main>",
    ...
    "                });",
    "            } catch (err) {",
    "                container.innerHTML = '<div class=\"text-center py-10 text-red-500 text-xs font-bold uppercase\">ERRORE DI CARICAMENTO CAMPIONATI:<br><span class=\"text-gray-400 text-[10px] lowercase font-normal block mt-2 px-4\">' + err.message + '</span></div>';",
    ...
    "                document.getElementById('dettagli-box-' + idCamp).classList.add('hidden');",
  ...
  return htmlLines.join(String.fromCharCode(10));
}